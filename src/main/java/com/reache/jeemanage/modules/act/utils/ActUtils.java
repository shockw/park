package com.reache.jeemanage.modules.act.utils;
...
import com.reache.jeemanage.common.annotation.FieldName;
import com.reache.jeemanage.common.config.Global;
import com.reache.jeemanage.common.utils.Encodes;
import com.reache.jeemanage.common.utils.ObjectUtils;
import com.reache.jeemanage.common.utils.StringUtils;
import com.reache.jeemanage.modules.act.entity.Act;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_OA_LOAN = new String[]{"oa_loan", "oa_loan"};
