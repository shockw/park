...
import com.reache.jeemanage.common.beanvalidator.BeanValidators;
...
import com.reache.jeemanage.common.utils.excel.ExportExcel;
import com.reache.jeemanage.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String info(HttpServletRequest request, User user,
			HttpServletResponse response, Model model) {
		...
		// 如果想异步获取内容，则返回JSON字符串
		if (WebUtils.isTrue(request, "__ajax")) {
